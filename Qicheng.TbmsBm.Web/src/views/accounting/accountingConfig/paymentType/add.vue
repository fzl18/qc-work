    ...
    <Modal class="closePositionModal" v-model="isShowAddModal" :title="isEdit ? $t('修改') : $t('新增')" width="500">
      <Form :model="form" label-position="right" :label-width="120" ref="form">
        <Row>
          ...
          <Col span="22" class-name="margin-bottom-10">
            <FormItem :label="$t('显示名称')" prop="friendlyName" required>
          ...
          <Col span="22" class-name="margin-bottom-10">
            <FormItem :label="$t('管理帐科目')" prop="accountingSubjectId" required>
              <Select
                placeholder
                filterable
                clearable
          ...
          <Col span="22" class-name="margin-bottom-10">
            <FormItem :label="$t('业务类型')" prop="businessTypeId" required>
              <Select
                transfer
                placeholder
                filterable
