            ...
            <el-row>
              ...
              <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
                <el-form-item label="简称" prop="shortName">
                  <el-input v-model="model.shortName" clearable placeholder=""/>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
                <el-form-item label="精度" prop="scale" class="full-width">
                  <el-input-number v-model="model.scale" :precision="0" :step="1" :max="8"
                                   :min="0"/>
                </el-form-item>
              </el-col>
