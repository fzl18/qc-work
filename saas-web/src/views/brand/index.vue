        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-tooltip content="编辑" placement="top">
              <el-button type="text" icon="el-icon-edit" @click="doEdit(scope.row)" v-hasAuth="[$route,'update']"
                         class="operation-btn"/>
            </el-tooltip>
            ...
            <el-row>
              ...
              <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
                <el-form-item label="源产地" prop="origin">
                  <el-input v-model="model.origin" clearable placeholder=""/>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
