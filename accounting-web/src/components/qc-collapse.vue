...
import Vue from 'vue'
    export default {
        ...
        mounted () {
           ...
           document.querySelector('.ivu-layout-content').style.overflow = 'hidden'
           this.mainView = document.querySelector('.mainview')
           this.balham = document.querySelector('.ag-theme-balham')
        },
        directives: {
            'getHeight': {
        ...
        methods: {
           ...
           expand() {
                ...
                if (this.balham) {
                   this.balham.style.transition = 'all .3s linear'
                }
                if(this.collapse) {
        ...
        destroyed() {
            document.querySelector('.ivu-layout-content').style.overflow = ''
            this.mainView.style.overflow = 'hidden auto'
